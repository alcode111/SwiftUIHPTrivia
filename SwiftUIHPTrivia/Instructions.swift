            ...
            VStack {
                ...
                ScrollView {
                    ...
                    VStack(alignment: .leading) {
                        ...
                        Text("If you are struggling with a question, there is an option to reveal a hint or the book that answers the question. But beware! Using these also minuses 1 point each.")
                            .padding([.horizontal, .bottom])
